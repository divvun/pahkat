= Páhkat Reference Implementation User Manual
...
ifdef::backend-html5[]
++++
<a href="https://github.com/bbqsrc/pahkat">
...
Please follow the warnings or errors that the `pahkat` tool provides, and if something is missing from the documentation, please open
an issue on GitHub.
====

== Introduction to Páhkat {projversion}
